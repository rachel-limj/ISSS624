...
-   **GWmodel** - R package for calibrating geographical weighted family of models. Thispackage provides a collection of **localised spatial statistical methods**, namely:
...
```{r}
packages = c('olsrr', 'corrplot', 'ggpubr', 'sf', 'spdep', 'GWmodel', 'tmap', 'tidyverse','terra')
for (p in packages){
...
#### 6.6.3.1 Checking for multicolinearity
...
#### 6.6.3.2 Test for Non-Linearity
...
#### 6.6.3.4 Testing for Spatial Autocorrelation
...
#### 6.7.5.1 By URA Plannign Region
