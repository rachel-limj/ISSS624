...
### use1.2.3 Importing GIS data in kml format
...
-   Master Plan 2014 Subzone Boundary (Web) (i.e. `MP14_SUBZONE_WEB_PL`) in ESRI shapefile format. This is a geospatial data based on URA Master Plan 2014. It consists of the geographical boundary of Singapore at the planning subzone level.
